...
################################################################################
## Form generated from reading UI file 'InterfaceIxgYMx.ui'
##
...
"}")
        ...
        self.leftMenuContainer.setMinimumSize(QSize(45, 0))
        self.leftMenuContainer.setMaximumSize(QSize(45, 16777215))
        self.leftMenuContainer.setSizeIncrement(QSize(0, 0))
        font = QFont()
        ...
        self.leftMenuSubContainer.setFont(font1)
        ...
        self.centerMenuSubContainer.setSizeIncrement(QSize(0, 0))
        ...
        self.closeCenterMenuBtn.setIconSize(QSize(24, 16))
        ...
        self.verticalLayout_8 = QVBoxLayout(self.page_9)
        ...
        self.verticalLayout_9 = QVBoxLayout(self.page_10)
        self.verticalLayout_9.setObjectName(u"verticalLayout_9")
        self.label_4 = QLabel(self.page_10)
        ...
        self.Help = QLabel(self.page_11)
        self.Help.setObjectName(u"Help")
        self.Help.setFont(font2)
        self.Help.setFrameShape(QFrame.Box)
        self.Help.setAlignment(Qt.AlignCenter)

        self.verticalLayout_10.addWidget(self.Help)

        self.centerMenuPages.addWidget(self.page_11)
        ...
        self.label_5.setPixmap(QPixmap(u":/icons/icons/Hamzzi.png"))
        ...
        self.profileMenuBtn.setFont(font)
        icon10 = QIcon()
        ...
        self.mainBodyContent.setMinimumSize(QSize(661, 321))
        ...
        self.mainContentsContainer.setFont(font)
        ...
        sizePolicy3.setHeightForWidth(self.rightMenuContainer.sizePolicy().hasHeightForWidth())
        self.rightMenuContainer.setSizePolicy(sizePolicy3)
        ...
        self.rightMenuSubContainer.setFont(font)
        ...
        self.closeRightMenuBtn.setFont(font)
        ...
        self.rightMenuPages.setFont(font)
        self.page_4 = QWidget()
        self.page_4.setObjectName(u"page_4")
        self.verticalLayout_14 = QVBoxLayout(self.page_4)
        self.verticalLayout_14.setObjectName(u"verticalLayout_14")
        self.Help_2 = QLabel(self.page_4)
        self.Help_2.setObjectName(u"Help_2")
        self.Help_2.setFont(font3)
        self.Help_2.setFrameShape(QFrame.Box)
        self.Help_2.setAlignment(Qt.AlignCenter)

        self.verticalLayout_14.addWidget(self.Help_2)
        ...
        self.Help_3 = QLabel(self.page_5)
        self.Help_3.setObjectName(u"Help_3")
        self.Help_3.setFont(font3)
        self.Help_3.setFrameShape(QFrame.Box)
        self.Help_3.setAlignment(Qt.AlignCenter)

        self.verticalLayout_13.addWidget(self.Help_3)
        ...
        self.verticalLayout_6.addWidget(self.rightMenuSubContainer, 0, Qt.AlignRight)


        self.horizontalLayout_3.addWidget(self.rightMenuContainer)
        ...
        self.popupNotificationContainer.setFont(font)
        ...
        self.popupNotificationSubContainer.setFont(font)
        ...
        self.closeNotificationBtn.setFont(font)
        icon14 = QIcon()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Hamzzi GuimNice", None))
        ...
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"Reports", None))
        ...
        self.Help_2.setText(QCoreApplication.translate("MainWindow", u"Profile", None))
        self.Help_3.setText(QCoreApplication.translate("MainWindow", u"More...", None))
        ...
        self.label_12.setText(QCoreApplication.translate("MainWindow", u"Copyright HukMuks", None))
    # retranslateUi
